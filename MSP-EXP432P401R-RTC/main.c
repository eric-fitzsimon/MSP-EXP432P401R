 ...
 *  Version: 0.1
 *  Description: Project that performs basic initializations and demonstrates minimal functionality of TIMER_A0, RTC and UART
 *
 *  Notes:
 *      No debounce implemented on button press.
 *      Timestamp is echoed to BCUART on button press.
 *      No error checking.
 *
 *
 */
...
void initRTC(void)
{
    // Configure RTC
      ...
      RTC_C->DATE = (0x5 << RTC_C_DATE_MON_OFS) | (0x08 | RTC_C_DATE_DAY_OFS); // Month = 0x04 = April // Day = 0x05 = 5th
